...
// #define DEBUG 		                                                        // Uncommented for debugging, comment
// out for normal use #define DEBUG1                                                            // Uncomment to see
// temperature and load information. #define DEBUG_SWITCH_CAL                                                  //
...
// #define DEBUG_CESSB                                                       // Uncomment to get CESSB operating
// parameters printed to the serial monitor. #define FAST_TUNE // Uncomment to activate variable speed fast tune by
// Harry GM3RVL.
...
#define MY_CALL "KO6HAX"     // Default max is 10 chars
...
#define TIME_24H 1
// DB2OO, 29-AUG-23: ITU_REGION to determine band borders: Upper band limits on 80m (3.8MHz vs 4.0MhHz) and 40m (7.2MHz
// vs. 7.3MHz) #define ITU_REGION                1 //for Europe
#define ITU_REGION 2  // for USA
// #define ITU_REGION    3   // Asia/Oceania
//  DB2OO, 29.823:. Analog Signal on this pin will be used for an analog S-Meter (250uA full scale) connected via 10kOhm
//  to this output. 1uF capacitor paralle to the S-Meter. --> Display.cpp. This might conflict with other hardware
//  modifications, that might use Pin 33 for a different purpose --> please check, before defining this
// #define HW_SMETER              33
//  DB2OO, 30-AUG-23: with TCVSDR_SMETER (TCVSDR=Teensy Convolution SDR) defined the S-Meter bar will be consistent with
//  the dBm value and it will not go over the box for S9+40+
#define TCVSDR_SMETER 1
// DB2OO, 10-SEP-23: TCXO_25MHZ defined sets the default EEPROMData.EEPROMData.freqCorrectionFactor = 0, as the TCXO is
// supposed to deliver 25.00000MHz #define TCXO_25MHZ                1
...
// https://github.com/Greg-R/qsd2/tree/easy?tab=readme-ov-file#software-modifications
...
#define DSPGAINSCALE \
    10.0  // A typical value for a V10/V11 radio is in the range of 5 to 15.
